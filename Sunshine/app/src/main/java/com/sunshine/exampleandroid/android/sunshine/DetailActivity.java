...
public class DetailActivity extends AppCompatActivity {
    ...
    public static String detail_string;
    /**
    ...
    private Intent createShareIntent() {
        ...
        shareIntent.putExtra(Intent.EXTRA_TEXT, detail_string+"#SunshineApp");
        return shareIntent;
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent() != null && getIntent().hasExtra("selecteditem")) {
            detail_string = getIntent().getStringExtra("selecteditem");
        }
    ...
    public void onStart() {
        ...
        Action viewAction = Action.newAction(
                ...
                Uri.parse("android-app://com.sunshine.exampleandroid.android.sunshine/http/host/path")
        );
